//! V5 → V6 → V7 storage key compatibility regression tests.
//!
//! # Purpose
//!
...
//! 2. Invoking V6/V7 read paths and asserting correct deserialization.
//! 3. Asserting that V6-only keys (discriminants 15–20) and V7-only keys (discriminants 21–28)
//!    are absent on a V5-seeded instance, confirming no phantom reads.
//!
